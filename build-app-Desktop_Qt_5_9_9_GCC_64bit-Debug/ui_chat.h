...
public:
    ...
    void setupUi(QDialog *chat)
    {
        ...
        chat->resize(348, 508);
        chat->setMinimumSize(QSize(338, 463));
        chat->setMaximumSize(QSize(16777215, 6546546));
...
"}"));
        ...
        label_9->setGeometry(QRect(140, 10, 41, 16));
        label_9->setFont(font);
        label_9->setStyleSheet(QLatin1String("font-size: 14px;\n"
"color: white;"));
        lineEdit_3 = new QLineEdit(frame);
        lineEdit_3->setObjectName(QStringLiteral("lineEdit_3"));
        lineEdit_3->setGeometry(QRect(5, 460, 291, 36));
...
"border-radius: 5px;"));
        ...
        pushButton->setGeometry(QRect(300, 460, 36, 36));
...
"}"));
        ...
        listWidget->setGeometry(QRect(5, 90, 331, 366));
        QFont font1;
        font1.setBold(false);
        font1.setWeight(50);
...
"color: white;"));
    ...
    void retranslateUi(QDialog *chat)
    {
        ...
        pushButton_8->setText(QApplication::translate("chat", "\342\234\230", Q_NULLPTR));
        pushButton_9->setText(QApplication::translate("chat", "_", Q_NULLPTR));
