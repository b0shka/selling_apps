...
public:
    ...
    void setupUi(QDialog *window_login)
    {
        ...
        frame->setGeometry(QRect(5, 5, 376, 286));
        frame->setMinimumSize(QSize(376, 286));
        frame->setMaximumSize(QSize(376, 286));
...
"color: white;"));
        ...
        lineEdit->setGeometry(QRect(75, 90, 226, 31));
...
"font-size: 14px;"));
        ...
        lineEdit_2->setGeometry(QRect(75, 130, 226, 31));
...
"font-size: 14px;"));
        ...
        pushButton->setGeometry(QRect(120, 175, 136, 31));
...
"}"));
        ...
        pushButton_2->setGeometry(QRect(95, 215, 186, 31));
...
"}"));
        ...
        label_3->setGeometry(QRect(5, 255, 366, 21));
        QFont font1;
        font1.setBold(false);
        ...
        frame_5->setGeometry(QRect(0, 0, 376, 26));
...
"}"));
        ...
        close->setGeometry(QRect(355, 5, 16, 16));
        QFont font2;
        font2.setBold(true);
        font2.setWeight(75);
        close->setFont(font2);
...
"}"));
        ...
        hide->setGeometry(QRect(330, 5, 16, 16));
        hide->setFont(font2);
